                        ...
                        <div class="col-xl">
                            <div class="card-margin card mb-4">
                                <div class="card-header align-items-center">
                                    <h5 class="display-4 uppercase text-center mb-0">Add Entity</h5>
                                </div>
                                <div class="card-body">
                                    <form action="{{ Route('entity.store') }}" method="POST">
                                        @csrf
                                        <div class="input-group input-group-merge mb-4">
                                            <span id="basic-icon-default-fullname2" class="input-group-text"><i class="mdi mdi-shape-plus"></i></span>
                                            <input
                                                required
                                                type="text"
                                                name="name"
