        ...
        <div class="row gy-4">
            ...
            <div class="col-md-12 col-lg-4">
                <div class="card">
                    ...
                    <img
                        src="{{ asset('img/icons/misc/triangle-light.png') }}"
                        class="scaleX-n1-rtl position-absolute bottom-0 end-0"
                        width="166"
                        alt="triangle background"
                        data-app-light-img="{{ asset('img/icons/misc/triangle-light.png') }}"
                        data-app-dark-img="{{ asset('img/icons/misc/triangle-dark.png') }}"
                    />
                    <img
                        ...
                        <ul class="p-0 m-0">
                            <li class="d-flex mb-4 pb-md-2">
                                <div class="avatar flex-shrink-0 me-3">
                                    <img src="{{ asset('img/icons/misc/zipcar.png') }}" alt="zipcar" class="rounded" />
                                </div>
                            ...
                            <li class="d-flex mb-4 pb-md-2">
                                <div class="avatar flex-shrink-0 me-3">
                                    <img src="{{ asset('img/icons/misc/bitbank.png') }}" alt="bitbank" class="rounded" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                            ...
                            <li class="d-flex mb-md-3">
                                <div class="avatar flex-shrink-0 me-3">
                                    <img src="{{ asset('img/icons/misc/aviato.png') }}" alt="aviato" class="rounded" />
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
                                ...
                                <ul class="p-0 m-0">
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img
                                            src="{{ asset('img/icons/payments/gumroad.png') }}"
                                            class="img-fluid"
                                            alt="gumroad"
                                            height="30"
                                            width="30" />
                                    ...
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img
                                            src="{{ asset('img/icons/payments/mastercard-2.png') }}"
                                            class="img-fluid"
                                            alt="mastercard"
                                            height="30"
                                            width="30" />
                                    ...
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img
                                            src="{{ asset('img/icons/payments/stripes.png') }}"
                                            class="img-fluid"
                                            alt="stripes"
                                            height="30"
                                            width="30" />
                                    ...
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img
                                            src="{{ asset('img/icons/payments/american-bank.png') }}"
                                            class="img-fluid"
                                            alt="american"
                                            height="30"
                                            width="30" />
                                    ...
                                    <li class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-3">
                                            <img
                                            src="{{ asset('img/icons/payments/citi.png') }}"
                                            class="img-fluid"
                                            alt="citi"
                                            height="30"
                                            width="30" />
                            ...
                            <div class="pt-2">
                                <ul class="p-0 m-0">
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img
                                            src="{{ asset('img/icons/brands/google.png') }}"
                                            class="img-fluid"
                                            alt="google"
                                            height="30"
                                            width="30" />
                                    ...
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img
                                            src="{{ asset('img/icons/brands/github.png') }}"
                                            class="img-fluid"
                                            alt="github"
                                            height="30"
                                            width="30" />
                                    ...
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img
                                            src="{{ asset('img/icons/brands/slack.png') }}"
                                            class="img-fluid"
                                            alt="slack"
                                            height="30"
                                            width="30" />
                                    ...
                                    <li class="d-flex mb-4 align-items-center pb-2">
                                        <div class="flex-shrink-0 me-3">
                                            <img
                                            src="{{ asset('img/icons/payments/digital-ocean.png') }}"
                                            class="img-fluid"
                                            alt="digital"
                                            height="30"
                                            width="30" />
                                    ...
                                    <li class="d-flex align-items-center">
                                        <div class="flex-shrink-0 me-3">
                                            <img
                                            src="{{ asset('img/icons/brands/aws.png') }}"
                                            class="img-fluid"
                                            alt="aws"
                                            height="30"
                                            width="30" />
