...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        form.addEventListener('submit', function (event) {
            ...
            const sectorId = document.getElementById('exampleFormControlSelect1').value;
            const searchURL = `/search?query=${encodeURIComponent(query)}&sector_id=${encodeURIComponent(sectorId)}`;

            // Redirect to the search page with query and sectorId
